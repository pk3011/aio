...
def load_config():
    ...
    KOLOP_KATDRIVE_CRYPT = environ.get('KOLOP_KATDRIVE_CRYPT', '')
    if len(KOLOP_KATDRIVE_CRYPT) == 0:
        KOLOP_KATDRIVE_CRYPT = ''
    ...
    SHARER_LARAVEL_SESSION = environ.get('SHARER_LARAVEL_SESSION', '')
    if len(SHARER_LARAVEL_SESSION) == 0:
        SHARER_LARAVEL_SESSION = ''
    SHARER_XSRF_TOKEN = environ.get('SHARER_XSRF_TOKEN', '')
    if len(SHARER_XSRF_TOKEN) == 0:
        SHARER_XSRF_TOKEN = ''
    ...
    config_dict.update({'APPDRIVE_EMAIL': APPDRIVE_EMAIL,
                        'APPDRIVE_PASS': APPDRIVE_PASS,
                        'AS_DOCUMENT': AS_DOCUMENT,
                        'AUTHORIZED_CHATS': AUTHORIZED_CHATS,
                        'AUTO_DELETE_MESSAGE_DURATION': AUTO_DELETE_MESSAGE_DURATION,
                        'BASE_URL': BASE_URL,
                        'CMD_PERFIX': CMD_PERFIX,
                        'DRIVEHUB_CRYPT': DRIVEHUB_CRYPT,
                        'DUMP_CHAT': DUMP_CHAT,
                        ...
                        'KOLOP_KATDRIVE_CRYPT': KOLOP_KATDRIVE_CRYPT,
                        ...
                        'SHARER_LARAVEL_SESSION': SHARER_LARAVEL_SESSION,
                        'SHARER_XSRF_TOKEN': SHARER_XSRF_TOKEN,
