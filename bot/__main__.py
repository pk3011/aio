...
from .modules import authorize, list, cancel_mirror, mirror_status, mirror_leech, clone, ytdlp, \
                     ...
                     fuck, mediainfo, poster, saavn_uploader, index_scraper, bypass
...
def start(update, context):
    buttons = ButtonMaker()
    buttons.buildbutton("Join Group", "https://t.me/MirrorRage")
...
'''
        ...
        sendMarkup('Join MirrorRage to use this bot.', context.bot, update.message, reply_markup)
...
/{BotCommands.FuckCommand}: To bypass movies sites.
/{BotCommands.BypassCommand[0]} or /{BotCommands.BypassCommand[1]}: Bypass Shortener Links.
/{BotCommands.SaavnCommand}: Download songs from JioSaavn Track links.
/{BotCommands.MediaInfoCommand[0]} or /{BotCommands.MediaInfoCommand[1]}: Get Mediainfo of streamable links.
/{BotCommands.IndexScrapeCommand[0]} or /{BotCommands.IndexScrapeCommand[1]}: Scrape Bhadoo Index folder links.
/{BotCommands.PosterCommand[0]} or /{BotCommands.PosterCommand[1]}: Get movies/series Posters from different sites.
