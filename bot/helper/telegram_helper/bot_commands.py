...
class _BotCommands:
    def __init__(self):
        self.BypassCommand = (f'bypass{CMD_PERFIX}', f'by{CMD_PERFIX}')
        self.IndexScrapeCommand = (f'index_scrape{CMD_PERFIX}', f'in{CMD_PERFIX}')
        self.SaavnCommand = f'jsvn{CMD_PERFIX}'
        self.PosterCommand = (f'poster{CMD_PERFIX}', f'p{CMD_PERFIX}')
        self.MediaInfoCommand = (f'mediainfo{CMD_PERFIX}', f'mi{CMD_PERFIX}')
        self.FuckCommand = f'fuck{CMD_PERFIX}'
        self.UpCommand = f'up{CMD_PERFIX}'
        self.DlCommand = f'dl{CMD_PERFIX}'
        self.GDlCommand = f'gdl{CMD_PERFIX}'
        self.ChandCommand = f'j{CMD_PERFIX}'
        self.GCommand = f'g{CMD_PERFIX}'
        ...
        self.CloneCommand = (f'clone{CMD_PERFIX}', f'cl{CMD_PERFIX}')
        ...
        self.ShellCommand = f'r{CMD_PERFIX}'
